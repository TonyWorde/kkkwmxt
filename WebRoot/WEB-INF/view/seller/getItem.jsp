 ...
 <body>
	<h1 style="text-align:center;color:#FF8000;"><img src="static/images/kkkwm.jpg" width="200" height="160"></img>快快快外卖</h1>
		<div class="container">
			...
			<li><a href="#adminPI" tabindex="-1" data-toggle="tab">订单详情</a></li>
		...
		<div class="container">
			...
			<div class="tab-pane fade in active" id="ywcorder">
	<table class="table table-hover">
        ...
        <tr>
            ...
            <c:forEach var="oi" items="${orderitem}">
                <tr>
                    <td>${oi.food_name}</td>
                    <td style="color: crimson">${oi.food_price}元/份</td>
                    <td>${oi.food_num}份</td>
                    <td style="color: brown">${oi.food_total}元</td>
                </tr>
        </c:forEach>
	</table>
	</div>
