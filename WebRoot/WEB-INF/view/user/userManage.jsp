	...
	<h1 style="text-align:center;color:#FF8000;"><img src="static/images/kkkwm.jpg" width="200" height="160"></img>快快快外卖</h1>
		<div class="container">
			<ul id="Tab" class="nav nav-pills" style="font-size:15pt">
				...
				<li><a href="userManageInUser" tabindex="-1" data-toggle="tab">我的信息</a></li>
		...
		<tr>
			...
			<td><a href="toDeposit"><input type="button" class="btn btn-warning" value="充值"></a></td>
		</tr>
	</thead>
	</table>
	<a href="toUpdateUser"><input type="button" class="btn btn-success" value="修改信息"></a>
	</div>
	</div>
	</div>
  </body>
