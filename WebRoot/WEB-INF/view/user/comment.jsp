	...
	<h1 style="text-align:center;color:#FF8000;"><img src="static/images/kkkwm.jpg" width="200" height="160"></img>快快快外卖</h1>
		<div class="container">
			<ul id="Tab" class="nav nav-pills" style="font-size:15pt">
				...
				<li><a href="toAddComment" tabindex="-1" data-toggle="tab">评论</a></li>
		...
		<div class="container">
		  	<form action="AddComment" method="post" commandName="comment">
		<h3>评价</h3>
			<div class="col-md-12 column">
				<textarea rows="10" cols="80" name="comment_content">
				</textarea>
